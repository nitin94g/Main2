...
BOT_TOKEN = environ.get('BOT_TOKEN', "6969502691:AAG7cbyJoGFjl5u8tdpdfYdczGdZiZ1y89U")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://yodipe4424:eEAusA10t3ejbvy4@cluster0.i4ht8dg.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "yodipe4424")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
VERIFY = bool(environ.get('VERIFY', False))
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'instantearn.in')
SHORTLINK_API = environ.get('SHORTLINK_API', '2448ad1ff8a23183ba7db3d8b4af00831e1cb61e')
...
URL = "https://autofiltermain1-d88e989482cc.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autofiltermain1-d88e989482cc.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autofiltermain1-d88e989482cc.herokuapp.com/".format(FQDN)
else:
    URL = "https://autofiltermain1-d88e989482cc.herokuapp.com/".format(FQDN)
